 ...
 * @static
 */
include(dirname(__FILE__)."/../default/latest.php");
...
class ExtModLatestView extends DefaultModLatestView  
{
	function displayLatestEvents(){
		...
		$callink_HTML = '<div class="mod_events_latest_callink" style="padding-bottom:5px">'
		. $this->_htmlLinkCloaking(JRoute::_("index.php?option=$compname" .  "&Itemid=". $this->myItemid . $this->catout, true), '> Upcoming Events')
		. '</div>';
