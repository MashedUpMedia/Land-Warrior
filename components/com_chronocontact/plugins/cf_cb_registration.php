...
class cf_cb_registration  {
	...
	<table border="0" cellpadding="3" cellspacing="0">
		...
		<tr style="background-color:#c9c9c9 ">
			...
			<td></td>
			<td><input type="text" class="inputbox" size="50" maxlength="50" name="params[<?php echo $field->name; ?>]" value="<?php echo $paramsvalues->$fieldname; ?>" /></td>
		</tr>
		<?php } ?>
		<tr style="background-color:#c9c9c9 ">
	...
	function onsubmit( $option, $params, $row ) {
		...
		global $cf_cbjust_registered;
		$cf_cbjust_registered = $user;
		...
		foreach($fields as $field){
			...
			$fields3[] = JRequest::getVar($params->$fieldname, '', 'post', 'string');//mosGetParam($_POST, $params->$fieldname, '');
		}
