...
class HTML_ChronoContact {
		...
		<tr>
			<td width="130px" valign="top">
				...
				foreach($results as $result){
					...
					${$result} = new $result();
					?>
					<a style="display:block; " href="javascript:if (document.adminForm.boxchecked.value == 0){ alert('Please make a selection from the list to <?php echo ${$result}->result_TITLE; ?>');}else{submitbutton('<?php echo 'plugin_'.$result; ?>')}">
   ...
   global $mainframe;
    ...
    ?>
	  ...
	  <script language="javascript" type="text/javascript">
		...
		function addEmail(){
			...
			new Element('input', {'type':'hidden', 'id': 'params_email_'+emailcounter, 'value':'1,html,0,1', 'name': 'params_email_'+emailcounter}).inject($('left_column33'));
	...
	<script type="text/javascript">
		...
		<?php } ?>
			...
			$$('.form_item').each(function(formitem){
  ...
  <tr style="background-color:#c9c9c9 ">
	...
	<tr style="background-color:#c9c9c9 ">
		...
		<td></td>
		<td>
		<input type="text" name="params[submissions_limit]" id="params[submissions_limit]" class="inputbox" size="50" maxlength="100" value="<?php echo $paramsvalues->submissions_limit; ?>">
		</td>
	</tr>
	...
	<tr>
		...
		<select name="params[LoadFiles]" id="params[LoadFiles]">
			<option<?php if($paramsvalues->LoadFiles == 'No'){ echo ' selected';} ?> value="No">No</option>
			<option<?php if($paramsvalues->LoadFiles == 'Yes'){ echo ' selected';} ?> value="Yes">Yes</option>
		</select>
		</td>
	</tr>
	<tr>
  ...
  <td valign="top">		
	...
	<?php
			...
			$storedtables = explode(",", $paramsvalues->tablenames);
	?>
	<div id="page-titlesx">
	<table border="0" cellpadding="3" cellspacing="0">
	<tr style="background-color:#c9c9c9 ">
		...
		<select name="params[dbconnection]" id="params[dbconnection]">
			<option<?php if($paramsvalues->dbconnection == 'No'){ echo ' selected';} ?> value="No">No</option>
			<option<?php if($paramsvalues->dbconnection == 'Yes'){ echo ' selected';} ?> value="Yes">Yes</option>
		</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<select name="params[savedataorder]" id="params[savedataorder]">
				<option<?php if($paramsvalues->savedataorder == 'after_email'){ echo ' selected';} ?> value="after_email">After Email</option>
				<option<?php if($paramsvalues->savedataorder == 'before_email'){ echo ' selected';} ?> value="before_email">Before Email</option>
		</select>
		</td>
	</tr>
	<tr style="background-color:#c9c9c9 ">
	...
	<tr>
		...
		<select name="params[handlepostedarrays]" id="params[handlepostedarrays]">
				<option<?php if($paramsvalues->handlepostedarrays == 'Yes'){ echo ' selected';} ?> value="Yes">Yes</option>
				<option<?php if($paramsvalues->handlepostedarrays == 'No'){ echo ' selected';} ?> value="No">No</option>
		</select>
		</td>
	</tr>
	</table>
	...
	<tr>
		...
		<td></td>
		<td>
		<input type="text" name="params[uploadfields]" id="params[uploadfields]" class="inputbox" size="100" value="<?php echo $paramsvalues->uploadfields; ?>">
		</td>
	</tr>
	<tr>		
		<td colspan="4">
		formula : [field_name][:][allowed_extension_1][|][allowed_extension_2][|][allowed_extension_n][{][max_size][-][min_size][}] [,] [next_field]...
		</td>
	</tr>
	...
	<tr style="background-color:#c9c9c9 ">
		...
		<td></td>
		<td>
		<input type="text" name="params[dvfields]" id="params[dvfields]" class="inputbox" size="50" value="<?php echo $paramsvalues->dvfields; ?>">
		</td>
	</tr>
	<tr style="background-color:#fff ">
		...
		<td></td>
		<td>
		<?php if(!trim($paramsvalues->dvrecord)){$paramsvalues->dvrecord = "Record #n";} ?>
		<input type="text" name="params[dvrecord]" id="params[dvrecord]" class="inputbox" size="50" value="<?php echo $paramsvalues->dvrecord; ?>">
		</td>
	</tr>
	</table>
	</div>
...
<?php
	...
	<td>What type of image to show ?</td><td>
				<select name="params[imtype]" id="params[imtype]">
					<option<?php if($paramsvalues->imtype == '0'){ echo ' selected';} ?> value="0">Without Fonts</option>
					<option<?php if($paramsvalues->imtype == '1'){ echo ' selected';} ?> value="1">With Fonts</option>
				</select>
				<?php
		} else {
...
?>
	...
	<tr>
	   ...
	   <select name="params[captcha_dataload]" id="params[captcha_dataload]">
					<option<?php if($paramsvalues->captcha_dataload == '0'){ echo ' selected';} ?> value="0">Dont Republish</option>
					<option<?php if($paramsvalues->captcha_dataload == '1'){ echo ' selected';} ?> value="1">Try to Republish</option>
				</select>
	   </td>
	</tr>
	<tr>
		...
		<td></td>
		<td>
		<input type="text" name="params[imgver_error_msg]" id="params[imgver_error_msg]" class="inputbox" size="50" value="<?php echo $paramsvalues->imgver_error_msg; ?>">
		</td>
	</tr>
	<tr>
	   <td>&nbsp;</td>
...
<?php
	...
	global $mainframe; ?>
	   <tr>
	       <td>&nbsp;</td>
	       <td>Sample image: </td>
	       <td><img src='<?php echo $mainframe->getSiteURL(); ?>components/com_chronocontact/chrono_verification.php<?php if($paramsvalues->imtype == '1'){ echo '?imtype=1';}else{ echo '?imtype=0';} ?>'></td>
	       </tr>
		   <?php
	}
?>
	...
	<tr style="background-color:#c9c9c9 ">
		...
		<select name="params[validatetype]" id="params[validatetype]">
			<option<?php if($paramsvalues->validatetype == 'mootools'){ echo ' selected';} ?> value="mootools">mootools</option>
		</select>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_required]" id="params[val_required]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_required; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_number]" id="params[val_validate_number]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_number; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_digits]" id="params[val_validate_digits]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_digits; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_alpha]" id="params[val_validate_alpha]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_alpha; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_alphanum]" id="params[val_validate_alphanum]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_alphanum; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_date]" id="params[val_validate_date]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_date; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_email]" id="params[val_validate_email]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_email; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_url]" id="params[val_validate_url]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_url; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_date_au]" id="params[val_validate_date_au]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_date_au; ?>">
		</td>
	</tr>
	<tr>
		<td><?php echo JHTML::_('tooltip', "Put list of fields names separated with comma *,* if more than one" ); ?></td>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_currency_dollar]" id="params[val_validate_currency_dollar]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_currency_dollar; ?>">
		</td>
	</tr>
	<tr>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_selection]" id="params[val_validate_selection]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_selection; ?>">
		</td>
	</tr>
	<tr>
		...
		<td></td>
		<td>
		<input type="text" name="params[val_validate_one_required]" id="params[val_validate_one_required]" class="inputbox" size="50" value="<?php echo $paramsvalues->val_validate_one_required; ?>">
		</td>
	</tr>
	...
	<?php
			...
			closedir($handler);
			$order = 0;
			$mplugins_order = explode(",", $paramsvalues->mplugins_order);
			foreach($results as $result){
			require_once(JPATH_SITE."/components/com_chronocontact/plugins/".$result.".php");
			${$result} = new $result();
	?>
	<tr style="background-color:#c9c9c9 ">
		...
		<td>
		<input type="checkbox" onClick="enable_order('mplugins_order_<?php echo ${$result}->result_TITLE; ?>','plugins_order_<?php echo ${$result}->result_TITLE; ?>')" id="plugins_order_<?php echo ${$result}->result_TITLE; ?>" name="plugins[]" <?php if(in_array($result,explode(",",$paramsvalues->plugins)))echo "checked"; ?> class="inputbox" size="50" value="<?php echo $result; ?>">
		</td>
		<td><input type="text" maxlength="2" <?php if(in_array($result,explode(",",$paramsvalues->plugins))){ ?><?php }else{ ?>disabled="true"<?php } ?> size="2" name="mplugins_order[]" id="mplugins_order_<?php echo ${$result}->result_TITLE; ?>" value="<?php if(in_array($result,explode(",",$paramsvalues->plugins))){echo $mplugins_order[$order];} ?>">
	...
	<?php
				if(in_array($result,explode(",",$paramsvalues->plugins))){
					$order++;
				}
			}	
	?>
	...
	if((!$paramsvalues->autogenerated_order)||(!$paramsvalues->onsubmitcode_order)||(!$paramsvalues->plugins_order)){
	...
	<tr style="background-color:#c9c9c9 ">
		...
		<td></td>
		<td>
		<input type="text" name="params[autogenerated_order]" id="params_autogenerated_order" class="inputbox" size="1" maxlength="1" value="<?php echo $paramsvalues->autogenerated_order; ?>">
	...
	<tr style="background-color:#c9c9c9 ">
		...
		<td></td>
		<td>
		<input type="text" name="params[onsubmitcode_order]" id="params_onsubmitcode_order" class="inputbox" size="1" maxlength="1" value="<?php echo $paramsvalues->onsubmitcode_order; ?>">
	...
	<tr style="background-color:#c9c9c9 ">
		...
		<td></td>
		<td>
		<input type="text" name="params[plugins_order]" id="params_plugins_order" class="inputbox" size="1" maxlength="1" value="<?php echo $paramsvalues->plugins_order; ?>">
...
function showdataChronoContact( $rows, $pageNav, $option, $formid, $table ) {
	...
	$registry = new JRegistry();
	$registry->loadINI( $formdata[0]->paramsall );
	$paramsvalues = $registry->toObject( );
    ...
    for ($i=0, $n=count($rows); $i < $n; $i++) {
	  ...
	  <tr class="<?php echo "row$k"; ?>">
		...
		<td width="20%"><a href="#viewdata" onclick="return listItemTask('cb<?php echo $i;?>','viewdata')">
		<?php 
		$dvrecord = $paramsvalues->dvrecord;
		foreach ( $names as $fname) {
			if ( is_a($fname, $row) ) {
				$dvrecord = preg_replace("/\\{".$fname."\\}/", $row->$fname, $dvrecord);
			}
		}
		echo str_replace("#n", $i, $dvrecord);
		?>		
		</a></td>
...
<tr><td><input type="submit" value="submit file"></td></tr>
	...
	?>
	<strong>This page is to help you add a menu link to the admin components menu to take you directly to the "show saved data" of some form you choose</strong><br><br>
	<script type="text/javascript">
	function submitbutton(pressbutton) {
		var form = document.adminForm;
 ...
 <script type="text/javascript" src="<?php echo JURI::Base().'components/com_chronocontact/js/'; ?>tiny_mce/tiny_mce.js"></script>
	...
	window.addEvent('domready', function() {
		...
		var marginChange = new Fx.Style('right_column', 'margin-top', {wait:false, duration:500, transition:Fx.Transitions.Elastic.easeOut});		
		window.addEvent('scroll', function() {
			if(($('left_column').getCoordinates().height + $('top_column').getCoordinates().height) > ($('right_column').getCoordinates().height + window.getScrollTop()) ){
				marginChange.start(Math.max(0, window.getScrollTop() - top));
			}
		});
		...
		window.addEvent('scroll', function() {
			marginChange2.start(Math.max(0, window.getScrollTop() - top2));
		});
	});
	</script>
...
<form action="index2.php" method="post" name="adminForm">
	...
	<h3 class="toggler atStart">STEP 1 - Design your form</h3>
		<div class="element atStart" id="formbuilder">
			...
			<div style="display:none; text-align:center " id="save_form">
				...
				<input type="text" name="form_title" value="" id="form_title" maxlength="20">
				<br><br>
				<input type="button" value="Save" onClick="Checkform()">
			</div>
		</div>
		<h3 class="toggler atStart">STEP 2 - Choose Email(s) Settings</h3>
		<div class="element atStart" id="emailbuilder">
			<div id="container">				
				<div class="float_left width1" >
					<div id="top_column2">				
					<a href="#" onClick="addEmail();return false;"><img id="cf_newemail" title="New Email :: Click to insert a new Email container" border="0" src="<?php echo JURI::Base().'components/com_chronocontact/css/'; ?>images/get_msgs_f2.png" width="32" height="32"></a>
					...
					<div id="left_column2"><div id="logdiv" style="color:#FF0000; text-align:center ">Click Add Email to add new Email</div></div>				   
				</div> 
		...
		<div class="element atStart" id="templatebuilder">
			<div id="container">				
				<div class="float_left width1" >
					<div id="top_column3">
					...
					<div id="left_column3" style="display:none; ">
					<div id="logdiv2" style="color:#FF0000; text-align:center ">If you left your Email template empty, a template will be automaticly generated similar to your form layout!</div>
		...
		<div class="element atStart" id="AfterFormSubmission">
			<div id="container">				
				<div class="float_left width1" >
					<div id="top_column4">
	...
	<input type="hidden" name="uploadfields" id="uploadfields" value="">
